...
const COUNTRIES: { code: string; name_en: string; name_es: string }[] = [
  ...
  { code: 'CD', name_en: 'Democratic Republic of the Congo', name_es: 'República Democrática del Congo' },
  { code: 'CF', name_en: 'Central African Republic', name_es: 'República Centroafricana' },
  { code: 'CG', name_en: 'Republic of the Congo', name_es: 'República del Congo' },
...
const UNITS = [
  { abbreviation_singular: 'g', abbreviation_plural: null, name_en: 'gram', name_es: 'gramos', synonyms: ['grams', 'gramo', 'gramos', 'g'] },
  { abbreviation_singular: 'kg', abbreviation_plural: null, name_en: 'kilogram', name_es: 'kilogramo', synonyms: ['kilogram', 'kg', 'kilo', 'kilos', 'kilogramo', 'kilogramos'] },
  { abbreviation_singular: 'pzc', abbreviation_plural: 'pzcs', name_en: 'pinch', name_es: 'pizca', synonyms: ['pinch', 'pizca', 'pzc'] },
  { abbreviation_singular: 'cdta', abbreviation_plural: 'cdtas', name_en: 'teaspoon', name_es: 'cucharadita', synonyms: ['teaspoon', 'cdta', 'cucharadita', 'cucharadita de té'] },
  { abbreviation_singular: 'cda', abbreviation_plural: 'cdas', name_en: 'tablespoon', name_es: 'cucharada sopera', synonyms: ['tablespoon', 'cda', 'cucharada', 'cucharada sopera'] },
  { abbreviation_singular: 'c/n', abbreviation_plural: null, name_en: 'amount needed', name_es: 'cantidad necesaria', synonyms: ['amount_needed', 'c/n', 'cantidad necesaria'] },
  { abbreviation_singular: 'ml', abbreviation_plural: null, name_en: 'milliliter', name_es: 'mililitros', synonyms: ['mililiter', 'mililitre', 'ml', 'mililitro', 'mililitros'] },
  { abbreviation_singular: 'l', abbreviation_plural: null, name_en: 'liter', name_es: 'litros', synonyms: ['liter', 'litre', 'l', 'litro', 'litros'] },
  { abbreviation_singular: 'cc', abbreviation_plural: null, name_en: 'cubic centimeter', name_es: 'centímetros cúbicos', synonyms: ['cubic_centimeter', 'cubic centimeter', 'cubic centimetre', 'cc', 'cm3', 'centímetro cúbico', 'centímetros cúbicos'] },
  { abbreviation_singular: 'taza', abbreviation_plural: 'tazas', name_en: 'cup', name_es: 'taza', synonyms: ['cup', 'taza', 'tazas'] },
  { abbreviation_singular: 'dado', abbreviation_plural: 'dados', name_en: 'dice', name_es: 'dado', synonyms: ['dice', 'dado', 'dados'] },
  { abbreviation_singular: 'diente', abbreviation_plural: 'dientes', name_en: 'clove', name_es: 'diente', synonyms: ['clove', 'diente', 'dientes'] },
];
